-- ============================================================
-- gold/collection_rate_v2_120j.sql
-- Collection Rate v2 — Seuil exclusion CLD > 120j
-- Variante pour présentation CODIR / usage interne
-- ============================================================
...
CREATE OR REPLACE VIEW gold.collection_rate_v2_120j AS
WITH
monthly_dates AS (
    SELECT
